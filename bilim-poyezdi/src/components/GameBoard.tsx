    ...
    <div className="mx-auto w-full max-w-[1440px] px-3 py-4 sm:px-4 sm:py-6">
      <div className="grid gap-4 xl:grid-cols-[1.15fr_0.85fr]">
        <div className="space-y-4">
          ...
          <section className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-xl">
            <div className="flex items-center justify-between gap-2">
              <h3 className="text-sm font-semibold uppercase tracking-[0.18em] text-white/70">Tracks</h3>
              <p className="text-xs text-white/50">Correct +10 | Fast +5 | Wrong -3</p>
            </div>
        ...
        <div className="space-y-4 xl:sticky xl:top-4 xl:self-start">
          ...
          <section className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-xl">
            <h3 className="text-sm font-semibold uppercase tracking-[0.18em] text-white/70">Teacher Controls</h3>
          ...
          <section className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-white/70 backdrop-blur-xl">
            <h4 className="font-semibold text-white">Rules</h4>
            <ul className="mt-2 space-y-1.5">
              <li>Correct answer: +10 points</li>
              <li>Fast bonus (&lt;10s): +5 points</li>
              <li>Wrong answer: -3 and back 1 station</li>
              <li>Turbo doubles one correct answer</li>
              <li>Shield cancels one wrong penalty</li>
            </ul>
          </section>
        </div>
      </div>
