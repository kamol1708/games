...
type BilimPoyezdiPageProps = {
  onBack?: () => void
}

function BilimPoyezdiPage({ onBack }: BilimPoyezdiPageProps) {
        ...
        {onBack ? (
          <div className="relative z-10 mx-auto w-full max-w-6xl px-4 pt-4">
            <button
              type="button"
              onClick={onBack}
              className="rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white/80 backdrop-blur hover:bg-white/10"
            >
              ← Games sahifasi
            </button>
          </div>
  ...
  return (
    <main className="relative min-h-screen bg-[#05060a] text-white">
      <BackgroundFX />
      {onBack ? (
        <div className="relative z-10 mx-auto w-full max-w-[1440px] px-3 pt-3 sm:px-4">
          <button
            type="button"
            onClick={onBack}
            className="rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white/80 backdrop-blur hover:bg-white/10"
...
export default BilimPoyezdiPage
