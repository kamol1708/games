...
const footerLinks = {
  Mahsulot: ['O‘yinlar', 'Imkoniyatlar', 'Premium'],
  Kompaniya: ['Biz haqimizda', 'Aloqa', 'Hamkorlik'],
  Resurslar: ['Qo‘llanma', 'FAQ', 'Yordam markazi'],
}
          ...
          <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr_0.8fr_0.8fr]">
            <div>
              ...
              <p className="mt-4 max-w-sm text-sm leading-6 text-white/60">
                Classroom uchun interaktiv o‘yinlar, premium sahifalar va teacher-friendly flow atrofida yig‘ilgan premium landing tajribasi.
              </p>
