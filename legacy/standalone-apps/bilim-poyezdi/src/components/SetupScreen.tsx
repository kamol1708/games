        ...
        <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="space-y-5 rounded-2xl border border-white/10 bg-[#0b1020]/70 p-5">
            ...
            <button
              ...
              disabled={!isValid}
              onClick={submit}
              className="shine relative w-full rounded-xl bg-gradient-to-r from-violet-500 to-blue-500 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-violet-500/20 transition hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-50"
            >
              O&apos;yinni Boshlash
            </button>
          </div>
